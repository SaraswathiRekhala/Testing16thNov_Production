...
package com.testing16thnov_production.dbscenarios.controller;
...
import com.testing16thnov_production.dbscenarios.service.DbscenariosProcedureExecutorService;
...
public class ProcedureExecutionController {
    ...
    public ProcedureInoutResponse executeProcedure_INOUT(@RequestParam(value = "charcol") String charcol, HttpServletRequest _request) {
        LOGGER.debug("Executing named procedure: Procedure_INOUT");
        ProcedureInoutResponse _result = procedureService.executeProcedure_INOUT(charcol);
