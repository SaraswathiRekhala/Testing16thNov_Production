 ...
 * @see Blobtypes
 */
@Service("SAMPLE.BlobtypesService")
@Validated
public class BlobtypesServiceImpl implements BlobtypesService {
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service SAMPLE for table Blobtypes to {} format", exportType);
