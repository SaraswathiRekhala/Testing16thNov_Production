...
package com.testing16thnov_production.dbscenarios1.controller;
...
import com.testing16thnov_production.dbscenarios1.service.ServerDefinedService;
...
public class ServerDefinedController {
    ...
    @Autowired
	@Qualifier("dbscenarios1.ServerDefinedService")
...
public ServerDefined createServerDefined(@RequestBody ServerDefined serverDefined) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ServerDefined getServerDefined(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public ServerDefined editServerDefined(@PathVariable("id") Integer id, @RequestBody ServerDefined serverDefined) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteServerDefined(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<ServerDefined> searchServerDefinedsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering ServerDefineds list");
